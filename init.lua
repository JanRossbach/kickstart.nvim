...
vim.keymap.set(
	"n",
	"<leader>fed",
	"<cmd>e ~/repositories/dotfiles/nvim/.config/nvim/init.lua<CR>",
...
vim.keymap.set(
	"n",
	"<leader>ms",
	"<cmd>MakeitToggleResults<cr>",
	{ noremap = true, silent = true, desc = "[M]ake [T]oggle" }
)
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>sn", function()
				builtin.find_files({ cwd = "~/repositories/dotfiles/nvim/.config/nvim/" })
